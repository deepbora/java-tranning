...
1) Process-based Multitasking (Multiprocessing)--**(when two or more process execute  simultaneously is called multiprocessing)**
...
i)Threads share the same address space.
ii)A thread is lightweight.


A)What is Thread in java?---

Ans-->A thread is a lightweight subprocess, the smallest unit of processing.

Multithreading in Java---***(is sub process executing simultaneously with in a process)***(Java Multithreading is mostly used in games, animation, etc.)
...
Thread o1 = new Thread(i);

o1.start();
II>*****using Thread Class****
...
****All methods are include in java.leng package--
so we can not import by default java compiler provieds US*****
